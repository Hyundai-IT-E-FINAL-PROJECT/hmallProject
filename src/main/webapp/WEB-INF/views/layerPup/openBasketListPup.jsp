                                ...
                                <div class="tblwrap">
                                    <table>
                                        ...
                                        <c:forEach items="${basketList}" var="basket">
                                            <tr>
                                                <td class="txt-center">
                                                    <input type="radio" id="product_seq" name="product_seq" value="${basket.productVO.product_seq}" />
                                                </td>
                                                <td class="txt-left nowrap">
                                                        ${basket.productVO.product_name}
                                                </td>
                                                <td class="txt-center">${basket.productVO.product_cost}</td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                                    </table>
...
<script type="text/javascript">
    function closePopup(){
        ...
        var product_seq=$("input[name='product_seq']:checked").val();
        ...
        $.ajax({
            ...
            success:function (info){
                //부모창에 값 전달
                console.log(info);
                opener.document.getElementById("order_seq").value=product_seq;
                opener.document.getElementById("product_code").value=info;
                window.close();
            },
