                            ...
                            <form id="combinationForm" method="get" action="#" class="form-horizontal">
                                ...
                                <div class="ps-wrap mb80">
                                    ...
                                    <div class="row row-mobile-n mb30">
                                        ...
                                        <div class="col-xs-9"><button type="button" class="btn btn-block btn-primary-outline">리워드 옵션 추가하기</button>
                                            <div class="option_group">
                                                <div class="row row-mobile-n option_select">
                                                    <div class="col-xs-12 text-right">
                                                        <div class="mt5">
                                                            <a href="javascript:void(0);" class="btn_none_icon btn_plus blue-800">추가하기</a>
                                                            <a href="javascript:void(0);" class="btn_none_icon btn_delete red-800">삭제하기</a></div>
                                                    </div>
                                                </div>
                                                <div id="option1_contents_radio1" class="row row-mobile-n otab1_contents mt10" style="display: none;">
                                                    <div class="col-xs-4"><input type="text" maxlength="30" placeholder="ex) 옷의 사이즈를 적어주세요." class="form-control ">
                                                    </div>
                                                    <div class="col-xs-8">
                                                        <div class="tokenfield form-control input-sm">
                                                            <input type="text" placeholder="키워드 입력 후 엔터를 눌러주세요." class="form-control input-sm keyword" value="" tabindex="-1" style="position: absolute; left: -10000px;">
                                                            <input type="text" tabindex="-1" style="position: absolute; left: -10000px;">
                                                            <input type="text" class="token-input" autocomplete="off" placeholder="키워드 입력 후 엔터를 눌러주세요." id="1654795031822109-tokenfield" tabindex="0" style="min-width: 60px; width: 108px;">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div id="option1_contents_radio2" class="row row-mobile-n otab1_contents mt10">
