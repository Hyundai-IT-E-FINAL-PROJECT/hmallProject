        ...
        <div class="gird-l2x">
                            ...
                            <div class="except-search">
                                <div class="inputbox">
                                    <label class="inplabel" for="searchKeyword"><input type="text"
                                                                                       ...
                                                                                       name="searchKeyword"
                                                                                       on
                                                                                       onkeypress="javascript:if(event.keyCode==13) {search($('#searchKeyword').val(), ${categoryVO.category_seq}, $('.ui-active').val());}"
            ...
            <div class="contents" id="pl_main">
                <div class="display-list-wrap" id="itemListArea">
                    <h2 class="title30" first_category="${categoryVO.category_seq}"><span>${categoryVO.category_name}</span> <em id="product-count">(${productVOList.size()})</em></h2>
