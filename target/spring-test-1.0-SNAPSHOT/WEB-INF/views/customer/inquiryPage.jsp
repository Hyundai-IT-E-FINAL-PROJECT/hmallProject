...
<head>
    ...
    <script type="text/javascript" src="//image.hmall.com/gen/js/new_main_data.js?ver=052711" charset="UTF-8"></script>
...
<%--                                                                                    ${pinfo.userVO.authList[0].user_auth_authority}--%>
...
<%--                                                             and pinfo.userVO.authList[0].user_auth_authority eq 'ROLE_ADMIN'}--%>
<%--&lt;%&ndash;&lt;%&ndash;                                                             답변 내용이 없을 경우+ 관리자일 경우&ndash;%&gt;--%>
<%--                                                             <c:when test="${qna.QA_CONTENT ne null}">--%>
<%--                                                                 <div>--%>
    ...
    <script type="text/javascript">
        ...
        function setOnAirSkySc(){
            try {
                $.ajax({
                    type: "get"
                    ,url: "https://wwwca.hmall.com/p/coe/onAirList.do?time=052711"
                    ,dataType: "html"
                    ,async: true
                    ,success : function(data) {
                    ...
                    ,error : function(e) {
                        ...
                        $.ajax({
                            type: "get"
                            ,url: "/p/coe/onAirList.do?time=052711"
                            ,dataType: "html"
                            ,async: true
                            ,success : function(data) {
                                $('#skyScOnAirArea').append(data);
        ...
        function setCardPromotion() {
            try {
                $.ajax({
                    type: "get"
                    ,url: "https://wwwca.hmall.com/p/coe/onAirCardPrmoList.do?time=052711"
                    ,dataType: "html"
                    ,async: true
                    ,success : function(data) {
                    ...
                    ,error : function(e) {
                        ...
                        $.ajax({
                            type: "get"
                            ,url: "/p/coe/onAirCardPrmoList.do?time=052711"
                            ,dataType: "html"
                            ,async: true
                            ,success : function(data) {
                                $('#skyScCardArea').append(data);
