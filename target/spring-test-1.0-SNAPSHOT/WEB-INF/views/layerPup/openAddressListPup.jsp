...
<div class="popup-win wd880 cus-opinion"> <!--20200828 금요일 pc레이아웃 공통작업 wd880 클래스 추가-->
    ...
    <div class="pop-wrap" tabindex="0">
        ...
        <div class="pop-content-wrap">
            <strong class="pop-title">배송지 선택</strong>
            <!--pop-content-->
                                ...
                                <div class="tblwrap">
                                    <table>
                                        ...
                                        <c:forEach items="${userAddressList}" var="address">
                                            <tr>
                                                <td>
                                                    <input type="radio" id="user_address_seq" name="user_address_seq" value="${address.user_address_seq}" />
                                                ...
                                                <td class="txt-center">${address.user_address_name}</td>
                                                <td class="txt-left nowrap">
                                                        ${address.user_address_address2}
                                                </td>
                                                <td class="txt-center">${address.user_address_phone_num}</td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                                    </table>
...
<script type="text/javascript">
    function closePopup(){
        ...
        var user_address_seq=$("input[name='user_address_seq']:checked").val();
        ...
        $.ajax({
            ...
            success:function (info){
                //부모창에 값 전달
                console.log(info);
                opener.document.getElementById("zipcode").value=info["user_address_address1"];
                opener.document.getElementById("order_delivery1").value=info["user_address_address2"];
                opener.document.getElementById("order_delivery2").value=info["user_address_address3"];
                window.close();
            },
