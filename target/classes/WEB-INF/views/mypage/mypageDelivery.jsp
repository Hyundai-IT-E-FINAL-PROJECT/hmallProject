          ...
          <div class="delivery-box">
            <ul class="list">
              ...
              <li>
                ...
                <input type="hidden" id="dstnBaseAdr" name="dstnBaseAdr" value="서울특별시 중랑구  망우로71가길 11-5(망우동, 어반캐슬)">
                ...
                <div class="btngroup abs">
                  <button id="modifyDstnAdr" name="modifyDstnAdr" class="btn btn-linelgray small30"><span>수정</span></button>
              ...
              <li>
                ...
                <input type="hidden" id="dstnBaseAdr" name="dstnBaseAdr" value="강원도 춘천시  백령로61번길 16-5 (효자동 168-79)">
                ...
                <button name="setBaseDstnAdr" class="btn btn-linelgray small30" data-dstnseq="0000000001"><span>기본배송지로</span></button>

                <div class="btngroup abs">
                  <button id="modifyDstnAdr" name="modifyDstnAdr" class="btn btn-linelgray small30"><span>수정</span></button>

                  <button id="deleteDstnAdr" name="deleteDstnAdr" class="btn btn-linelgray small30"><span>삭제</span></button>
